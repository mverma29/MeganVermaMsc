...
``` {r}
owid <- read_csv("data/owid_covid.csv") # replace NULL with file name
```
...
```{r}
# it changes the estimates drastically, but p values seem similar (? no decimals?) and conf int are similarly tight so not sure how to determine this 
