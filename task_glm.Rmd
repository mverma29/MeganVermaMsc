...
Megan: Yes, for every 10-fold increase in GDP, there is a ~3-fold increase in cases
...
un_hh_iso_plot <- merge(y=un_hh_iso, x=world, by.y="iso_code_l", by.x="iso_a3", all.x = TRUE) #lost 6 countries
