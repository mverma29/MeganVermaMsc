...
# sam: better to use a condition to be met rather than hard-coding a row given
# the position of this row may change

mod_1df <- filter(mod_1df, p <= 1, p >= 0)
...
Megan: should i redo all models but in total cases (not per million) so that we can put cyprus back in? 
