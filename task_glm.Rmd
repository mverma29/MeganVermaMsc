...
mod_1df <- drop_na(mod_1df, "SI.POV.GINI") ## 140 countries 
mod_1df <- drop_na(mod_1df, "mean_hh") ## down to 134 countries from 140
...
mod_1df <- mod_1df %>% mutate (p= total_cases/pop_est)
