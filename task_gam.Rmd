...
covid_data <- read_csv("/Users/meganverma/Desktop/git/MeganVermaMsc/data/glmcoviddata.csv")
...
summary(gam_gdp_smooth) # is the output that for every 10-fold increase in gdp, the total cases per million decreases by 3.4 (percent?)? 
